  ...
  <article class="contents-container clearfix">
    ...
    <section class="contents-inner">
      ...
      <div class="general-container">
        <h2>新着情報削除</h2>
        <p class="notification notice"><i class="fa fa-info-circle"></i>一覧より削除する新着情報にチェックをして「削除情報の確認画面へ」ボタンを押してください。</p>
        <form method="post" action="news03_conf.php">
          ...
          <?php
            ...
            {
          ?>
          <button class="submit-button" name="submit" type="submit">削除情報の確認画面へ</button>
          <?php
            }
          ?>
        </form>
