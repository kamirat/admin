          ...
          <table class="general-form">
            ...
            <tr>
              ...
              <td>
                ...
                <input name="url_text" type="hidden" value="<?=$_POST['url_text']?>">
              </td>
            </tr>
            <?php
              }else{
            ...
            <tr>
              ...
              <td>
                ...
                ?>
                <input id="link-01" class="input-radio" name="link" type="radio" value="0"<?=$checked1?>><label for="link-01">リンクしない</label><br>
                <input id="link-02" class="input-radio" name="link" type="radio" value="1"<?=$checked2?>><label for="link-02">現在のタブでリンクを開く</label><br>
                <input id="link-03" class="input-radio" name="link" type="radio" value="2"<?=$checked3?>><label for="link-03">新規のタブでリンクを開く</label>
              </td>
            </tr>
            <tr>
              <th abbr="start2">リンク先URL</th>
              <td>
                ...
                <!--<input class="input-general" name="url" type="text" id="url">-->
                <input name="url_text" type="hidden" id="url">
              </td>
            </tr>
            <?php
              }
